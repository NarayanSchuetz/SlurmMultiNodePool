...
if __name__ == "__main__":
    ...
    job_manager = SlurmMultiNodePool(num_tasks=5, job_name='test', log_directory='.',
                                     time_limit='00:10:00', mem_limit='1G', email="schuetzn@stanford.edu",
                                     partition='owners', python_script_name='tmp.py')
    job_manager.create_job(test_function, *["helolo", "world", "blubbed-blob"])
